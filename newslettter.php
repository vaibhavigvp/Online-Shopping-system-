					...
					<div class="col-md-12">
						...
						<div class="newsletter">
							...
							<ul class="newsletter-follow">
								...
								<li>
									<a href="https://twitter.com/VGovankop?t=3fkcl15cdj2n2MTR--MkEg&s=09"><i class="fa fa-twitter"></i></a>
								</li>
								<li>
									<a href="https://instagram.com/vaibhavi_gvp?igshid=NGExMmI2YTkyZg=="><i class="fa fa-instagram"></i></a>
								</li>
								<li>
									<a href="https://github.com/vaibhavigvp"><i class="fa fa-github"></i></a>
								</li>
							</ul>
						</div>
					</div>
